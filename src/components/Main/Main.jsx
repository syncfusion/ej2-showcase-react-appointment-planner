...
export const Main = () => {
    ...
    const onItemClick = (args) => {
        ...
        if (args.currentTarget) {
            navigate('/' + args.currentTarget.id);
        }
        const elements = [].slice.call(args.currentTarget.parentElement.querySelectorAll('.active-item'));
    ...
    return (<div className='planner-wrapper'>
